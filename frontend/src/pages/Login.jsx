...
const Login = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            setIsLoading(true)
            const res = await axios.post(`http://3.26.153.200:8000/user/login`, formData, {
                headers: {
                    ...
                    <div className='w-full max-w-md space-y-6 flex flex-col items-center'>
                        ...
                        <Card className="w-full max-w-sm">
                            ...
                            <CardFooter className="flex-col gap-2">
                                ...
                                <Button onClick={()=>window.open("http://3.26.153.200:8000/auth/google", "_self")} className='w-full' variant='outline'>
